...
// DO NOT EDIT.
// source: fe2o3-agent_schema.capnp
...
pub mod point {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 48] = [
      ...
      ::capnp::word(153, 42, 7, 180, 233, 206, 220, 175),
      ::capnp::word(25, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(65, 218, 210, 85, 135, 93, 237, 128),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(102, 101, 50, 111, 51, 45, 97, 103),
      ::capnp::word(101, 110, 116, 95, 115, 99, 104, 101),
      ::capnp::word(109, 97, 46, 99, 97, 112, 110, 112),
    ...
    pub const TYPE_ID: u64 = 0xafdc_cee9_b407_2a99;
  }
}
...
pub mod point_tracker {
  ...
  impl <_T :Server> ServerDispatch<_T> {
    pub fn dispatch_call_internal(server: &mut _T, method_id: u16, params: ::capnp::capability::Params<::capnp::any_pointer::Owned>, results: ::capnp::capability::Results<::capnp::any_pointer::Owned>) -> ::capnp::capability::Promise<(), ::capnp::Error> {
      match method_id {
        0 => server.add_point(::capnp::private::capability::internal_get_typed_params(params), ::capnp::private::capability::internal_get_typed_results(results)),
        _ => { ::capnp::capability::Promise::err(::capnp::Error::unimplemented("Method not implemented.".to_string())) }
      }
    }
  }
  pub mod _private {
    pub const TYPE_ID: u64 = 0xf61b_51c7_8af3_048a;
  }
  ...
  pub mod add_point_params {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 35] = [
        ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
        ::capnp::word(252, 184, 139, 105, 134, 252, 178, 187),
      ...
      pub const TYPE_ID: u64 = 0xbbb2_fc86_698b_b8fc;
    }
  }
  ...
  pub mod add_point_results {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 36] = [
        ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
        ::capnp::word(189, 124, 249, 1, 162, 246, 194, 159),
      ...
      pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
      pub static MEMBERS_BY_NAME : &[u16] = &[0];
      pub const TYPE_ID: u64 = 0x9fc2_f6a2_01f9_7cbd;
    }
  }
}
